...
int NeoInit()
{
	...
	if ( bBurnUseRomCache ) {
		...
		{
			YM2610ADPCMAROM = (unsigned char *)UpperMalloc(nYM2610ADPCMASize);
			BurnCacheRead(YM2610ADPCMAROM, 3);			
		}
		if (nYM2610ADPCMBSize)
		{
			YM2610ADPCMAROM = (unsigned char *)UpperMalloc(nYM2610ADPCMBSize);
...
int NeoExit()
{
	...
	NeoTextROM = NULL;
	if ( !bBurnUseRomCache )
		UpperFree(NeoSpriteROM);						// Sprite ROM
	NeoSpriteROM = NULL;
