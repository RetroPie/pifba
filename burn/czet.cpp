...
unsigned char __fastcall CZetDummyReadHandler(unsigned short) { return 0; }
void __fastcall CZetDummyWriteHandler(unsigned short, unsigned char) { }
unsigned char __fastcall CZetDummyInHandler(unsigned short) { return 0; }
void __fastcall CZetDummyOutHandler(unsigned short, unsigned char) { }
