...
static int DrvExit()
{
	...
	UpperFree(PsikyoSpriteROM);
	PsikyoSpriteROM = NULL;
	UpperFree(PsikyoTileROM);
	PsikyoTileROM = NULL;
	UpperFree(PsikyoSampleROM01);
	PsikyoSampleROM01 = NULL;
	UpperFree(PsikyoSampleROM02);
...
static int DrvInit()
{
	...
	PsikyoSpriteROM		= UpperMalloc(PsikyoSpriteROMSize);
	PsikyoTileROM		= UpperMalloc(PsikyoTileROMSize);
	PsikyoSampleROM01	= UpperMalloc(PsikyoSampleROM01Size);
	PsikyoSampleROM02	= UpperMalloc(PsikyoSampleROM02Size);
